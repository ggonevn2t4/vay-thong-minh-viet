...
const MarketplaceTabs = ({
  ...
  // For customers, only show offers tab
  // For advisors, only show requests tab
  const showRequestsTab = userRole === 'advisor' || (!userRole);
  const showOffersTab = userRole === 'customer' || (!userRole);

  // Set default active tab based on role
  const defaultTab = userRole === 'customer' ? 'offers' : 'requests';
