...
import { MapPin, Clock, User, TrendingUp, MessageCircle, ArrowRight, CheckCircle, Eye } from 'lucide-react';
    ...
    <>
      <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-md group">
        ...
        <CardFooter className="pt-4 space-y-3">
          <Button onClick={handleViewDetail} className="w-full bg-brand-600 hover:bg-brand-700 font-semibold py-3 group">
        ...
        <LoanRequestDetail 
          request={{
            ...
            borrowerProfile: {
              ...
              employmentType: 'Nhân viên IT',
              workExperience: 5,
              currentDebts: 50000000,
              assets: ['Ô tô', 'Tiết kiệm ngân hàng']
            },
            documents: [
              {
