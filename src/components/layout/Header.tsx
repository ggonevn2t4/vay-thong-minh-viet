...
import { Menu, User, LogOut, Settings, MessageSquare, Wallet, Home } from 'lucide-react';
...
const Header = () => {
  ...
  // Create nav items for floating navbar
  ...
  return (
    <>
      ...
      {/* Original Header for mobile and user actions */}
