...
-- Step 1: Create sample profiles for different user types
INSERT INTO public.profiles (id, full_name, phone, gender, date_of_birth, employment_type, monthly_income, work_experience_years, kyc_verified) VALUES
-- Customer profiles
('11111111-1111-1111-1111-111111111111', 'Nguyễn Văn An', '0901234567', 'male', '1990-05-15', 'employee', 25000000, 5, true),
('22222222-2222-2222-2222-222222222222', 'Trần Thị Bình', '0912345678', 'female', '1985-08-20', 'self_employed', 35000000, 8, true),
('33333333-3333-3333-3333-333333333333', 'Lê Hoàng Cường', '0923456789', 'male', '1992-12-10', 'employee', 18000000, 3, false),
-- Advisor profiles  
('44444444-4444-4444-4444-444444444444', 'Phạm Thị Dung', '0934567890', 'female', '1980-03-25', 'employee', 45000000, 12, true),
('55555555-5555-5555-5555-555555555555', 'Võ Minh Đức', '0945678901', 'male', '1983-07-12', 'employee', 50000000, 15, true),
-- Bank employee profile
('66666666-6666-6666-6666-666666666666', 'Đinh Thị Giang', '0956789012', 'female', '1988-11-30', 'employee', 40000000, 10, true);
...
-- Step 15: Create document requests
INSERT INTO public.document_requests (
  id, customer_id, advisor_id, loan_application_id, document_type, document_name,
  description, status
) VALUES
('doc11111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222',
 '55555555-5555-5555-5555-555555555555', 'eeee2222-2222-2222-2222-222222222222',
 'income_proof', 'Chứng minh thu nhập', 
 'Cần bổ sung giấy chứng nhận thu nhập từ cơ quan thuế hoặc sổ sách kế toán', 'requested'),
('doc22222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222',
 '55555555-5555-5555-5555-555555555555', 'eeee2222-2222-2222-2222-222222222222',
 'property_docs', 'Sổ đỏ bất động sản', 
 'Cần photo công chứng sổ đỏ của bất động sản thế chấp', 'requested');

-- Step 16: Create sample documents
INSERT INTO public.documents (
  id, user_id, name, description, file_path, content_type, category, status
) VALUES
('docfile1-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111',
 'CMND_Nguyen_Van_An.pdf', 'Chứng minh nhân dân của Nguyễn Văn An',
 'documents/cmnd_nguyen_van_an.pdf', 'application/pdf', 'identity', 'approved'),
('docfile2-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222',
 'So_do_nha_Tran_Thi_Binh.pdf', 'Sổ đỏ nhà của Trần Thị Bình',
 'documents/so_do_tran_thi_binh.pdf', 'application/pdf', 'property', 'pending');

-- Step 17: Create offer comparisons for testing
INSERT INTO public.offer_comparisons (
  id, user_id, comparison_name, loan_amount, loan_term_months, loan_purpose, offers
) VALUES
('comp1111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111',
 'So sánh vay kinh doanh 200 triệu', 200000000, 24, 'Kinh doanh',
 '[
   {"bank": "Vietcombank", "rate": 8.5, "amount": 200000000, "fees": 1000000},
   {"bank": "Techcombank", "rate": 9.2, "amount": 180000000, "fees": 800000},
   {"bank": "BIDV", "rate": 10.1, "amount": 160000000, "fees": 600000}
 ]');

-- Step 18: Create CIC history for testing
INSERT INTO public.customer_cic_history (
  id, customer_id, bank_name, purpose, impact_score
) VALUES
('cic11111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111',
 'Vietcombank', 'Thẩm định hồ sơ vay', 5),
('cic22222-2222-2222-2222-222222222222', '22222222-2222-2222-2222-222222222222',
 'BIDV', 'Đánh giá tín dụng', 3);
